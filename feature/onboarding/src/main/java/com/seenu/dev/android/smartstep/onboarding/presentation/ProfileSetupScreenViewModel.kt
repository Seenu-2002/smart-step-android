package com.seenu.dev.android.smartstep.onboarding.presentation
...
import com.seenu.dev.android.smartstep.onboarding.mapper.toDomainModel
...
class ProfileSetupScreenViewModel constructor(
    ...
    val uiState: StateFlow<ProfileSetupScreenUiState> = _uiState.asStateFlow()
